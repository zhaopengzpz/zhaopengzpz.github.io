...
//看板娘样式设置
live2d_settings['waifuSize']            = '140x125';    // 看板娘大小，例如 '280x250', '600x535'
live2d_settings['waifuTipsSize']        = '125x35';     // 提示框大小，例如 '250x70', '570x150'
live2d_settings['waifuFontSize']        = '6px';       // 提示框字体，例如 '12px', '30px'
live2d_settings['waifuToolFont']        = '7px';       // 工具栏字体，例如 '14px', '36px'
live2d_settings['waifuToolLine']        = '10px';       // 工具栏行高，例如 '20px', '36px'
live2d_settings['waifuToolTop']         = '0px'         // 工具栏顶部边距，例如 '0px', '-60px'
live2d_settings['waifuMinWidth']        = '384px';      // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
